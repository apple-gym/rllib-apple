...
class GenerativeResnet3Headless(nn.Module):
    ...
    def __init__(self, input_channels=4, output_channels=1, channel_size=16, dropout=False, prob=0.0):
        ...
        self.head1 = nn.Conv2d(64, 32, 1)
        self.head2 = nn.Conv2d(32, 16, 1)
        self.head3 = nn.Conv2d(16, 4, 1)
        # self.head3 = nn.Conv2d(4, 4, 1, bias=False)
...
class ProcessObservation(nn.Module):
    ...
    reduce_obs_space = int(np.prod(old_img_size) - np.prod(new_img_size))
    ...
    def first_half(self):
        self.feature_extractor.first_half()
